...
public class ShoppingActivity extends ActionBarActivity  {
    ...
    final String Shop_Showcase = "Shop_Showcase";

    private ListView mDrawerList;
    SlidingTabLayout slidingTabLayout;
    ViewPager myViewPager;

    private String shopping[] = new String[]{"Welcome", "Shopping Cart", "ToBuy List", "Suggestions"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myViewPager.setAdapter(new ShoppingPagerAdapter(getSupportFragmentManager(), shopping));
        ...
        Boolean Show_Done = mPrefs.getBoolean(Shop_Showcase, false);

        if (!Show_Done) {
            /* */
            ShowcaseView.Builder showCaseBuilder = new ShowcaseView.Builder(this);

            showCaseBuilder.setTarget(new ViewTarget(((Toolbar) findViewById(R.id.toolbar)).getChildAt(0)));
            showCaseBuilder.setContentTitle("Welcome to Onstore");
            showCaseBuilder.setContentText("Let's us Explore");

            showCaseBuilder.build();

            SharedPreferences.Editor editor = mPrefs.edit();
            editor.putBoolean(Shop_Showcase, true);
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    case 0:
                        ...
                        /* Do nothing when clicked as this the same activity */
                    ...
                    case 1:
                        ...
                        Intent OnStore = new Intent(ShoppingActivity.this, OnStoreActivity.class);
                    ...
                    case 2:
                        ...
                        Intent SearchProducts = new Intent(ShoppingActivity.this, SearchProductsActivity.class);
                    ...
                    case 3:
                        ...
                        Intent History = new Intent(ShoppingActivity.this, HistoryActivity.class);
                    ...
                    case 4:
                        ...
                        Intent Settings = new Intent(ShoppingActivity.this,SettingsActivity.class);
                    ...
                    case 5:
                        ...
                        Intent Feedback = new Intent(ShoppingActivity.this, FeedBackActivity.class);
