 ...
 */
public class HistoryViewAdapter extends RecyclerSwipeAdapter<HistoryViewAdapter.SimpleViewHolder> {


    public static class SimpleViewHolder extends RecyclerView.ViewHolder {
        SwipeLayout swipeLayout;
        TextView textViewPos;
        TextView  productData, priceData;
        ImageView trash;
        ImageView favorite;
        ImageView magnifier;
    ...
    public HistoryViewAdapter(Context context, ArrayList<String> objects) {
    ...
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        ...
        /* Database Extraction */
        String productInfo = PurchaseDb.Purchase_id;
        String priceInfo = PurchaseDb.Purchase_amount;
        ...
        viewHolder.trash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(view.getContext(), "Sorry Cannot delete History data ", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        viewHolder.favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(view.getContext(), "History data its private ", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        viewHolder.magnifier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(view.getContext(), "Search for Purchase Id ", Toast.LENGTH_SHORT).show();
            }
        });
